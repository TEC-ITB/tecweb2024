          ...
          <div className="pt-12">
            ...
            <div className="mt-12 text-white flex flex-col items-center justify-center">
              ...
              <div className="px-12 w-full flex flex-col md:flex-row justify-between items-center gap-8 md:gap-6 md:mx-16 pt-[4vw] pb-[1vw]">
                <Image src="/program1.png" className="w-full h-auto" alt="our-program-1" width={200} height={200} />
                <Image src="/program2.png" className="w-full h-auto" alt="our-program-2" width={200} height={200} />
                <Image src="/program3.png" className="w-full h-auto" alt="our-program-3" width={200} height={200} />
              </div>
