...
export default function Home() {
  return (
    <main className="bg-black h-full w-full pt-[80px]">
      ...
      <section className="bg-[#002b6a] py-[2vw] flex flex-col justify-center items-center">
        <h1 className="text-white text-[5vw] md:text-[3vw] flex justify-center items-center font-bold">
          TECFEST 2025
        </h1>
        <Link
          href="https://tecfest.tecitb.com/"
          target="_blank"
          className="ml-4"
        >
      ...
      <section id="about-us" className="h-full bg-black ">
        <div className="pt-12">
          <div className="bg-[url('/bg-visi-misi.svg')] px-[10vw] h-[40vw] text-white bg-contain bg-no-repeat justify-center flex flex-col bg-[center_top_50%]">
            <h1 className="text-[10vw] md:text-[8vw] text-left">Our Vision</h1>
            <h2 className="text-[5vw] md:text-[3vw]">
              <span style={{ color: "#5493ef" }}>Eskalasi alterasi</span> TEC
              ITB sebagai wadah aktualisasi diri yang inklusif dan kolaboratif
              serta berdampak secara global
            </h2>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-2 md:gap-0 px-[8vw] py-[10vw] border-b-4 border-[#002B6A] bg-[#0E0E0E]">
          <div className="flex items-center gap-4 ">
            <h1 className="text-[10vw] md:text-[8vw] font-bold text-gray-500">
              1
            </h1>
            <h2 className="text-[3vw] md:text-[1.5vw] text-gray-300">
              Meningkatkan efisiensi dan keberlanjutan operasional pada berbagai
              program kerja sesuai dengan tujuan yang telah ditetapkan.
            </h2>
          </div>
          <div className="flex items-center gap-4 ">
            <h1 className="text-[10vw] md:text-[8vw] font-bold text-gray-500">
            ...
            <h2 className="text-[3vw] md:text-[1.5vw] text-gray-300">
              Mengubah dan menyempurnakan berbagai aspek yang memiliki potensi
              untuk menghasilkan dampak signifikan.
            </h2>
          </div>
          <div className="flex items-center gap-4 ">
            <h1 className="text-[10vw] md:text-[8vw] font-bold text-gray-500">
            ...
            <h2 className="text-[3vw] md:text-[1.5vw] text-gray-300">
              Menciptakan ekosistem pembelajaran yang dinamis dan inovatif untuk
              mendukung pengembangan keterampilan dan pengetahuan kewirausahaan
              anggota.
            </h2>
          </div>
          <div className="flex items-center gap-4 ">
            ...
            <h2 className="text-[3vw] md:text-[1.5vw] text-gray-300">
              Mendorong anggota untuk saling berkolaborasi dengan mengedepankan
              profesional dan harmonisasi.
            </h2>
          </div>
          <div className="flex items-center gap-4">
            <h1 className="text-[10vw] md:text-[8vw] font-bold text-gray-500">
            ...
            <h2 className="text-[3vw] md:text-[1.5vw] text-gray-300">
              Mengembangkan dan memperluas jaringan kerjasama dengan berbagai
              organisasi.
            </h2>
          </div>
        </div>
        ...
        <div className="mt-12 text-white flex flex-col items-center justify-center">
          ...
          <Link href="/our-program">
            <button className="bg-[#002B6A] text-white text-[3vw] md:text-[1vw] py-2 px-4 rounded-lg mt-4 mb-6 hover:bg-[#002a6a9f] transition-colors hover:scale-[1.05]">
              See More
            </button>
          </Link>
        </div>
